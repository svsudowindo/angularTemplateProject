 ...
 */
  ...
  static toIsoString(input: Date) {
    let tzo = -input.getTimezoneOffset(),
      dif = tzo >= 0 ? '+' : '-',
      pad = function (num) {
  ...
  static getDateInCustomFormat(inputDateString: string) {
    ...
    let date = String(inputDate.getDate() < 10 ? '0' + inputDate.getDate() : inputDate.getDate());
    let month = String((inputDate.getMonth() + 1) < 10 ? '0' + (inputDate.getMonth() + 1) : (inputDate.getMonth() + 1));
    let fullyear = String(inputDate.getFullYear());
    let hours = String(inputDate.getHours() < 10 ? '0' + inputDate.getHours() : inputDate.getHours());
    let minutes = String(inputDate.getMinutes() < 10 ? '0' + inputDate.getMinutes() : inputDate.getMinutes());
    let seconds = String(inputDate.getSeconds() < 10 ? '0' + inputDate.getSeconds() : inputDate.getSeconds());
  ...
  static getTime(inputString: string) {
    try {
      ...
      let inputDateFormat = new Date(parseInt(arr[0]), parseInt(arr[1]) - 1, parseInt(arr[2]), parseInt(arr[3]), parseInt(arr[4]), parseInt(arr[5]));
      let inputDate = new Date(inputDateFormat);
  ...
  static getTimeFromString(inputString: string) {
    try {
      let arr = inputString.split(" ");
      let inputDateFormat = new Date(inputString);
      let inputDate = new Date(inputDateFormat);
      let hours: number = inputDate.getHours();
      let minutes: number = inputDate.getMinutes();
      let hoursString: string = "";
