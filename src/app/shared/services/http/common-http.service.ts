...
export class CommonHttpService {
    ...
    // @param path
    // @param body
    private put(path: string, body = {}, requestOptions): Observable<any> {
    ...
    // @param path
    // @param body
    private post(path: string, body = {}, requestOptions): Observable<any> {
    ...
    // @param body
    // @param customHeaders
    private patch(path: string, body = {}, requestOptions): Observable<any> {
